...
_See code: [src/commands/plugins/index.ts](https://github.com/oclif/plugin-plugins/blob/5.1.3-dev.0/src/commands/plugins/index.ts)_
...
_See code: [src/commands/plugins/inspect.ts](https://github.com/oclif/plugin-plugins/blob/5.1.3-dev.0/src/commands/plugins/inspect.ts)_
...
_See code: [src/commands/plugins/install.ts](https://github.com/oclif/plugin-plugins/blob/5.1.3-dev.0/src/commands/plugins/install.ts)_
...
_See code: [src/commands/plugins/link.ts](https://github.com/oclif/plugin-plugins/blob/5.1.3-dev.0/src/commands/plugins/link.ts)_
...
_See code: [src/commands/plugins/reset.ts](https://github.com/oclif/plugin-plugins/blob/5.1.3-dev.0/src/commands/plugins/reset.ts)_
...
_See code: [src/commands/plugins/uninstall.ts](https://github.com/oclif/plugin-plugins/blob/5.1.3-dev.0/src/commands/plugins/uninstall.ts)_
...
_See code: [src/commands/plugins/update.ts](https://github.com/oclif/plugin-plugins/blob/5.1.3-dev.0/src/commands/plugins/update.ts)_
